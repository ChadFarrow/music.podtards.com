import{css as e,LitElement as t,svg as o,html as n}from"lit";import{state as r,customElement as i,property as a}from"lit/decorators.js";import{createStore as l}from"zustand/vanilla";import{webln as s}from"@getalby/sdk";function c(e,t,o,n){var r,i=arguments.length,a=i<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,o):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,n);else for(var l=e.length-1;l>=0;l--)(r=e[l])&&(a=(i<3?r(a):i>3?r(t,o,a):r(t,o))||a);return i>3&&a&&Object.defineProperty(t,o,a),a}"function"==typeof SuppressedError&&SuppressedError;let d=!1;class p{constructor(e){this._config=e}async init(){if(!window.webln)throw new Error("window.webln does not exist");await window.webln.enable()}async getBalance(){try{if(!window.webln)throw new Error("webln not found");const e=await(null==window.webln.getBalance?void 0:window.webln.getBalance());return null==e?void 0:e.balance}catch(e){console.error("Failed to get balance",e)}}async getAlias(){try{if(!window.webln)throw new Error("webln not found");return(await window.webln.getInfo()).node.alias}catch(e){return void console.error("Failed to get alias",e)}}}class f extends p{constructor(e){if(super(e),!e.nwcUrl)throw new Error("no nwc URL provided");const t=new s.NostrWebLNProvider({nostrWalletConnectUrl:e.nwcUrl});window.webln=t}}const u={"extension.generic":class extends p{constructor(e){super(e)}async init(){await new Promise(e=>setTimeout(e,1e3)),await super.init()}},"nwc.alby":f,"nwc.generic":f};function h(e){const t=new Event(e,{bubbles:!0,composed:!0});window.dispatchEvent(t)}const g=l(e=>({connector:void 0,config:void 0,setConfig:t=>{e({config:t})},setConnector:t=>{e({connector:t})}})),C=l(e=>({route:"/start",connected:!1,connecting:!1,alias:void 0,balance:void 0,connectorName:void 0,connect:async t=>{h("bc:connecting"),e({connecting:!0});try{const o=new u[t.connectorType](t);await o.init();const n=await o.getBalance(),r=await o.getAlias();g.getState().setConfig(t),g.getState().setConnector(o),e({connected:!0,connecting:!1,balance:n,alias:r,connectorName:t.connectorName}),h("bc:connected")}catch(t){console.error(t),e({connecting:!1})}!function(e){window.localStorage.setItem("bc:config",JSON.stringify(e))}(t)},disconnect:()=>{g.getState().setConfig(void 0),g.getState().setConnector(void 0),e({connected:!1,alias:void 0,balance:void 0,connectorName:void 0}),window.localStorage.removeItem("bc:config"),h("bc:disconnected")},setAlias:t=>{e({alias:t})},setBalance:t=>{e({balance:t})},getConnectorName:()=>{var e;return null==(e=g.getState().config)?void 0:e.connectorName},setRoute:t=>{e({route:t})}}));let b;!function(){const e=window.localStorage.getItem("bc:config");if(e){const t=JSON.parse(e);C.getState().connect(t)}}(),window.addEventListener("webln:enabled",async()=>{C.getState().connecting||await C.getState().connect({connectorName:"Extension",connectorType:"extension.generic"})});class m extends t{}m.styles=[e(b||(b=(e=>e)`
      :host {
        all: initial;
        font-variant-numeric: slashed-zero;
      }
    `))];class y extends m{constructor(){super(),this._connected=!1,this._connecting=!1,this._connectorName=void 0,this._alias=void 0,this._balance=void 0,function(){if(!d){d=!0;for(const e of["Inter","Roboto Mono"]){const t=document.createElement("link");t.href=`https://fonts.googleapis.com/css2?family=${e}:wght@400;500;600;700&display=swap`,t.rel="stylesheet",document.head.appendChild(t)}}}(),this._connected=C.getState().connected,this._connecting=C.getState().connecting,this._alias=C.getState().alias,this._balance=C.getState().balance,this._connectorName=C.getState().connectorName,C.subscribe(e=>{this._connected=e.connected,this._connecting=e.connecting,this._alias=e.alias,this._balance=e.balance,this._connectorName=e.connectorName})}connectedCallback(){super.connectedCallback()}}function w(e){return[...e.v,(e.i?"!":"")+e.n].join(":")}function x(e,t=","){return e.map(w).join(t)}c([r()],y.prototype,"_connected",void 0),c([r()],y.prototype,"_connecting",void 0),c([r()],y.prototype,"_connectorName",void 0),c([r()],y.prototype,"_alias",void 0),c([r()],y.prototype,"_balance",void 0);let v="undefined"!=typeof CSS&&CSS.escape||(e=>e.replace(/[!"'`*+.,;:\\/<=>?@#$%&^|~()[\]{}]/g,"\\$&").replace(/^\d/,"\\3$& "));function L(e){for(var t=9,o=e.length;o--;)t=Math.imul(t^e.charCodeAt(o),1597334677);return"#"+((t^t>>>9)>>>0).toString(36)}function $(e,t="@media "){return t+k(e).map(e=>("string"==typeof e&&(e={min:e}),e.raw||Object.keys(e).map(t=>`(${t}-width:${e[t]})`).join(" and "))).join(",")}function k(e=[]){return Array.isArray(e)?e:null==e?[]:[e]}function M(e){return e}function S(){}let _={d:0,b:134217728,c:268435456,a:671088640,u:805306368,o:939524096};function Z(e){return e.match(/[-=:;]/g)?.length||0}function F(e){return Math.min(/(?:^|width[^\d]+)(\d+(?:.\d+)?)(p)?/.test(e)?Math.max(0,29.63*(+RegExp.$1/(RegExp.$2?15:1))**.137-43):0,15)<<22|Math.min(Z(e),15)<<18}let O=["rst-c","st-ch","h-chi","y-lin","nk","sited","ecked","pty","ad-on","cus-w","ver","cus","cus-v","tive","sable","tiona","quire"];function z({n:e,i:t,v:o=[]},n,r,i){e&&(e=w({n:e,i:t,v:o})),i=[...k(i)];for(let e of o){let t=n.theme("screens",e);for(let o of k(t&&$(t)||n.v(e)))i.push(o),r|=t?67108864|F(o):"dark"==e?1073741824:"@"==o[0]?F(o):1<<~(/:([a-z-]+)/.test(o)&&~O.indexOf(RegExp.$1.slice(2,7))||-18)}return{n:e,p:r,r:i,i:t}}let A=new Map;function j(e){if(e.d){let t=[],o=E(e.r.reduce((e,o)=>"@"==o[0]?(t.push(o),e):o?E(e,e=>E(o,t=>{let o=/(:merge\(.+?\))(:[a-z-]+|\\[.+])/.exec(t);if(o){let n=e.indexOf(o[1]);return~n?e.slice(0,n)+o[0]+e.slice(n+o[1].length):R(e,t)}return R(t,e)})):e,"&"),t=>R(t,e.n?"."+v(e.n):""));return o&&t.push(o.replace(/:merge\((.+?)\)/g,"$1")),t.reduceRight((e,t)=>t+"{"+e+"}",e.d)}}function E(e,t){return e.replace(/ *((?:\(.+?\)|\[.+?\]|[^,])+) *(,|$)/g,(e,o,n)=>t(o)+n)}function R(e,t){return e.replace(/&/g,t)}let T=new Intl.Collator("en",{numeric:!0});function V(e,t){for(var o=0,n=e.length;o<n;){let r=n+o>>1;0>=D(e[r],t)?o=r+1:n=r}return n}function D(e,t){let o=e.p&_.o;return o!=(t.p&_.o)||o!=_.b&&o!=_.o?e.p-t.p||e.o-t.o||T.compare(W(e.n),W(t.n))||T.compare(H(e.n),H(t.n)):0}function W(e){return(e||"").split(/:/).pop().split("/").pop()||"\0"}function H(e){return(e||"").replace(/\W/g,e=>String.fromCharCode(127+e.charCodeAt(0)))+"\0"}function U(e,t){return Math.round(parseInt(e,16)*t)}function B(e,t={}){if("function"==typeof e)return e(t);let{opacityValue:o="1",opacityVariable:n}=t,r=n?`var(${n})`:o;if(e.includes("<alpha-value>"))return e.replace("<alpha-value>",r);if("#"==e[0]&&(4==e.length||7==e.length)){let t=(e.length-1)/3,o=[17,1,.062272][t-1];return`rgba(${[U(e.substr(1,t),o),U(e.substr(1+t,t),o),U(e.substr(1+2*t,t),o),r]})`}return"1"==r?e:"0"==r?"#0000":e.replace(/^(rgb|hsl)(\([^)]+)\)$/,`$1a$2,${r})`)}function N(e,t,o,n,r=[]){return function e(t,{n:o,p:n,r=[],i},a){let l=[],s="",c=0,d=0;for(let u in t||{}){var p,f;let h=t[u];if("@"==u[0]){if(!h)continue;if("a"==u[1]){l.push(...Y(o,n,Q(""+h),a,n,r,i,!0));continue}if("l"==u[1]){for(let t of k(h))l.push(...e(t,{n:o,p:(p=_[u[7]],n&~_.o|p),r:"d"==u[7]?[]:r,i},a));continue}if("i"==u[1]){l.push(...k(h).map(e=>({p:-1,o:0,r:[],d:u+" "+e})));continue}if("k"==u[1]){l.push({p:_.d,o:0,r:[u],d:e(h,{p:_.d},a).map(j).join("")});continue}if("f"==u[1]){l.push(...k(h).map(t=>({p:_.d,o:0,r:[u],d:e(t,{p:_.d},a).map(j).join("")})));continue}}if("object"!=typeof h||Array.isArray(h))"label"==u&&h?o=h+L(JSON.stringify([n,i,t])):(h||0===h)&&(u=u.replace(/[A-Z]/g,e=>"-"+e.toLowerCase()),d+=1,c=Math.max(c,"-"==(f=u)[0]?0:Z(f)+(/^(?:(border-(?!w|c|sty)|[tlbr].{2,4}m?$|c.{7,8}$)|([fl].{5}l|g.{8}$|pl))/.test(f)?+!!RegExp.$1||-!!RegExp.$2:0)+1),s+=(s?";":"")+k(h).map(e=>a.s(u,I(""+e,a.theme)+(i?" !important":""))).join(";"));else if("@"==u[0]||u.includes("&")){let t=n;"@"==u[0]&&(u=u.replace(/\bscreen\(([^)]+)\)/g,(e,o)=>{let n=a.theme("screens",o);return n?(t|=67108864,$(n,"")):e}),t|=F(u)),l.push(...e(h,{n:o,p:t,r:[...r,u],i},a))}else l.push(...e(h,{p:n,r:[...r,u]},a))}return l.unshift({n:o,p:n,o:Math.max(0,15-d)+1.5*Math.min(c||15,15),r,d:s}),l.sort(D)}(e,z(t,o,n,r),o)}function I(e,t){return e.replace(/theme\((["'`])?(.+?)\1(?:\s*,\s*(["'`])?(.+?)\3)?\)/g,(e,o,n,r,i="")=>{let a=t(n,i);return"function"==typeof a&&/color|fill|stroke/i.test(n)?B(a):""+k(a).filter(e=>Object(e)!==e)})}function P(e,t){let o,n=[];for(let r of e)r.d&&r.n?o?.p==r.p&&""+o.r==""+r.r?(o.c=[o.c,r.c].filter(Boolean).join(" "),o.d=o.d+";"+r.d):n.push(o={...r,n:r.n&&t}):n.push({...r,n:r.n&&t});return n}function G(e,t,o=_.u,n,r){let i=[];for(let a of e)for(let e of function(e,t,o,n,r){let i=function(e,t){let o=A.get(e.n);return o?o(e,t):t.r(e.n,"dark"==e.v[0])}(e={...e,i:e.i||r},t);return i?"string"==typeof i?(({r:n,p:o}=z(e,t,o,n)),P(G(Q(i),t,o,n,e.i),e.n)):Array.isArray(i)?i.map(e=>{var t,r;return{o:0,...e,r:[...k(n),...k(e.r)],p:(t=o,r=e.p??o,t&~_.o|r)}}):N(i,e,t,o,n):[{c:w(e),p:0,o:0,r:[]}]}(a,t,o,n,r))i.splice(V(i,e),0,e);return i}function Y(e,t,o,n,r,i,a,l){return P((l?o.flatMap(e=>G([e],n,r,i,a)):G(o,n,r,i,a)).map(e=>e.p&_.o&&(e.n||t==_.b)?{...e,p:e.p&~_.o|t,o:0}:e),e)}function q(e,t,o,n){return A.set(e,(e,r)=>{let{n:i,p:a,r:l,i:s}=z(e,r,t);return o&&Y(i,t,o,r,a,l,s,n)}),e}function J(e,t,o){if("("!=e[e.length-1]){let o=[],n=!1,r=!1,i="";for(let t of e)if("("!=t&&!/[~@]$/.test(t)){if("!"==t[0]&&(t=t.slice(1),n=!n),t.endsWith(":")){o["dark:"==t?"unshift":"push"](t.slice(0,-1));continue}"-"==t[0]&&(t=t.slice(1),r=!r),t.endsWith("-")&&(t=t.slice(0,-1)),t&&"&"!=t&&(i+=(i&&"-")+t)}i&&(r&&(i="-"+i),t[0].push({n:i,v:o.filter(X),i:n}))}}function X(e,t,o){return o.indexOf(e)==t}let K=new Map;function Q(e){let t=K.get(e);if(!t){let o=[],n=[[]],r=0,i=0,a=null,l=0,s=(t,i=0)=>{r!=l&&(o.push(e.slice(r,l+i)),t&&J(o,n)),r=l+1};for(;l<e.length;l++){let t=e[l];if(i)"\\"!=e[l-1]&&(i+=+("["==t)||-("]"==t));else if("["==t)i+=1;else if(a)"\\"!=e[l-1]&&a.test(e.slice(l))&&(a=null,r=l+RegExp.lastMatch.length);else if("/"!=t||"\\"==e[l-1]||"*"!=e[l+1]&&"/"!=e[l+1])if("("==t)s(),o.push(t);else if(":"==t)":"!=e[l+1]&&s(!1,1);else if(/[\s,)]/.test(t)){s(!0);let e=o.lastIndexOf("(");if(")"==t){let t=o[e-1];if(/[~@]$/.test(t)){let r=n.shift();o.length=e,J([...o,"#"],n);let{v:i}=n[0].pop();for(let e of r)e.v.splice(+("dark"==e.v[0])-+("dark"==i[0]),i.length);J([...o,q(t.length>1?t.slice(0,-1)+L(JSON.stringify([t,r])):t+"("+x(r)+")",_.a,r,/@$/.test(t))],n)}e=o.lastIndexOf("(",e-1)}o.length=e+1}else/[~@]/.test(t)&&"("==e[l+1]&&n.unshift([]);else a="*"==e[l+1]?/^\*\//:/^[\r\n]/}s(!0),K.set(e,t=n[0])}return t}function ee(e,t,o){return[e,te(t,o)]}function te(e,t){return"function"==typeof e?e:"string"==typeof e&&/^[\w-]+$/.test(e)?(o,n)=>({[e]:t?t(o,n):oe(o,1)}):t=>e||{[t[1]]:oe(t,2)}}function oe(e,t,o=e.slice(t).find(Boolean)||e.$$||e.input){return"-"==e.input[0]?`calc(${o} * -1)`:o}function ne(e,t,o,n){return[e,re(t,o,n)]}function re(e,t,o){let n="string"==typeof t?(e,n)=>({[t]:o?o(e,n):e._}):t||(({1:e,_:t},o,n)=>({[e||n]:t}));return(t,o)=>{let r=ce(e||t[1]),i=o.theme(r,t.$$)??se(t.$$,r,o);if(null!=i)return t._=oe(t,0,i),n(t,o,r)}}function ie(e,t={},o){return[e,ae(t,o)]}function ae(e={},t){return(o,n)=>{let{section:r=ce(o[0]).replace("-","")+"Color"}=e,[i,a]=(o.$$.match(/^(\[[^\]]+]|[^/]+?)(?:\/(.+))?$/)||[]).slice(1);if(!i)return;let l=n.theme(r,i)||se(i,r,n);if(!l||"object"==typeof l)return;let{opacityVariable:s=`--tw-${o[0].replace(/-$/,"")}-opacity`,opacitySection:c=r.replace("Color","Opacity"),property:d=r,selector:p}=e,f=n.theme(c,a||"DEFAULT")||a&&se(a,c,n),u=t||(({_:e})=>{let t=le(d,e);return p?{[p]:t}:t});o._={value:B(l,{opacityVariable:s||void 0,opacityValue:f||void 0}),color:e=>B(l,e),opacityVariable:s||void 0,opacityValue:f||void 0};let h=u(o,n);if(!o.dark){let e=n.d(r,i,l);e&&e!==l&&(o._={value:B(e,{opacityVariable:s||void 0,opacityValue:f||"1"}),color:t=>B(e,t),opacityVariable:s||void 0,opacityValue:f||void 0},h={"&":h,[n.v("dark")]:u(o,n)})}return h}}function le(e,t){let o={};return"string"==typeof t?o[e]=t:(t.opacityVariable&&t.value.includes(t.opacityVariable)&&(o[t.opacityVariable]=t.opacityValue||"1"),o[e]=t.value),o}function se(e,t,o){if("["==e[0]&&"]"==e.slice(-1)){if(e=de(I(e.slice(1,-1),o.theme)),!t)return e;if(!(/color|fill|stroke/i.test(t)&&!/^color:/.test(e)&&!/^(#|((hsl|rgb)a?|hwb|lab|lch|color)\(|[a-z]+$)/.test(e)||/image/i.test(t)&&!/^image:/.test(e)&&!/^[a-z-]+\(/.test(e)||/weight/i.test(t)&&!/^(number|any):/.test(e)&&!/^\d+$/.test(e)||/position/i.test(t)&&/^(length|size):/.test(e)))return e.replace(/^[a-z-]+:/,"")}}function ce(e){return e.replace(/-./g,e=>e[1].toUpperCase())}function de(e){return e.includes("url(")?e.replace(/(.*?)(url\(.*?\))(.*?)/g,(e,t="",o,n="")=>de(t)+o+de(n)):e.replace(/(^|[^\\])_+/g,(e,t)=>t+" ".repeat(e.length-t.length)).replace(/\\_/g,"_").replace(/(calc|min|max|clamp)\(.+\)/g,e=>e.replace(/(-?\d*\.?\d(?!\b-.+[,)](?![^+\-/*])\D)(?:%|[a-z]+)?|\))([+\-/*])/g,"$1 $2 "))}function pe({presets:e=[],...t}){let o={darkMode:void 0,darkColor:void 0,preflight:!1!==t.preflight&&[],theme:{},variants:k(t.variants),rules:k(t.rules),ignorelist:k(t.ignorelist),hash:void 0,stringify:(e,t)=>e+":"+t,finalize:[]};for(let n of k([...e,{darkMode:t.darkMode,darkColor:t.darkColor,preflight:!1!==t.preflight&&k(t.preflight),theme:t.theme,hash:t.hash,stringify:t.stringify,finalize:t.finalize}])){let{preflight:e,darkMode:t=o.darkMode,darkColor:r=o.darkColor,theme:i,variants:a,rules:l,ignorelist:s,hash:c=o.hash,stringify:d=o.stringify,finalize:p}="function"==typeof n?n(o):n;o={preflight:!1!==o.preflight&&!1!==e&&[...o.preflight,...k(e)],darkMode:t,darkColor:r,theme:{...o.theme,...i,extend:{...o.theme.extend,...i?.extend}},variants:[...o.variants,...k(a)],rules:[...o.rules,...k(l)],ignorelist:[...o.ignorelist,...k(s)],hash:c,stringify:d,finalize:[...o.finalize,...k(p)]}}return o}function fe(e,t,o,n,r,i){for(let a of t){let t=o.get(a);t||o.set(a,t=n(a));let l=t(e,r,i);if(l)return l}}function ue(e){var t;return ge(e[0],"function"==typeof(t=e[1])?t:()=>t)}function he(e){return Array.isArray(e)?ge(e[0],te(e[1],e[2])):ge(e,te(void 0,void 0))}function ge(e,t){return Ce(e,(e,o,n,r)=>{let i=o.exec(e);if(i)return i.$$=e.slice(i[0].length),i.dark=r,t(i,n)})}function Ce(e,t){let o=k(e).map(be);return(e,n,r)=>{for(let i of o){let o=t(e,i,n,r);if(o)return o}}}function be(e){return"string"==typeof e?RegExp("^"+e+(e.includes("$")||"-"==e.slice(-1)?"":"$")):e}function me(e){let t=e?.cssRules?e:(e&&"string"!=typeof e?e:function(e){let t=document.querySelector(e||'style[data-twind=""]');return t&&"STYLE"==t.tagName||(t=document.createElement("style"),document.head.prepend(t)),t.dataset.twind="claimed",t}(e)).sheet;return{target:t,snapshot(){let e=Array.from(t.cssRules,e=>e.cssText);return()=>{this.clear(),e.forEach(this.insert)}},clear(){for(let e=t.cssRules.length;e--;)t.deleteRule(e)},destroy(){t.ownerNode?.remove()},insert(e,o){try{t.insertRule(e,o)}catch(e){t.insertRule(":root{}",o)}},resume:S}}let ye={screens:{sm:"640px",md:"768px",lg:"1024px",xl:"1280px","2xl":"1536px"},columns:{auto:"auto","3xs":"16rem","2xs":"18rem",xs:"20rem",sm:"24rem",md:"28rem",lg:"32rem",xl:"36rem","2xl":"42rem","3xl":"48rem","4xl":"56rem","5xl":"64rem","6xl":"72rem","7xl":"80rem"},spacing:{px:"1px",0:"0px",.../* #__PURE__ */ve(4,"rem",4,.5,.5),.../* #__PURE__ */ve(12,"rem",4,5),14:"3.5rem",.../* #__PURE__ */ve(64,"rem",4,16,4),72:"18rem",80:"20rem",96:"24rem"},durations:{75:"75ms",100:"100ms",150:"150ms",200:"200ms",300:"300ms",500:"500ms",700:"700ms",1e3:"1000ms"},animation:{none:"none",spin:"spin 1s linear infinite",ping:"ping 1s cubic-bezier(0,0,0.2,1) infinite",pulse:"pulse 2s cubic-bezier(0.4,0,0.6,1) infinite",bounce:"bounce 1s infinite"},aspectRatio:{auto:"auto",square:"1/1",video:"16/9"},backdropBlur:/* #__PURE__ */Le("blur"),backdropBrightness:/* #__PURE__ */Le("brightness"),backdropContrast:/* #__PURE__ */Le("contrast"),backdropGrayscale:/* #__PURE__ */Le("grayscale"),backdropHueRotate:/* #__PURE__ */Le("hueRotate"),backdropInvert:/* #__PURE__ */Le("invert"),backdropOpacity:/* #__PURE__ */Le("opacity"),backdropSaturate:/* #__PURE__ */Le("saturate"),backdropSepia:/* #__PURE__ */Le("sepia"),backgroundColor:/* #__PURE__ */Le("colors"),backgroundImage:{none:"none"},backgroundOpacity:/* #__PURE__ */Le("opacity"),backgroundSize:{auto:"auto",cover:"cover",contain:"contain"},blur:{none:"none",0:"0",sm:"4px",DEFAULT:"8px",md:"12px",lg:"16px",xl:"24px","2xl":"40px","3xl":"64px"},brightness:{.../* #__PURE__ */ve(200,"",100,0,50),.../* #__PURE__ */ve(110,"",100,90,5),75:"0.75",125:"1.25"},borderColor:({theme:e})=>({DEFAULT:e("colors.gray.200","currentColor"),...e("colors")}),borderOpacity:/* #__PURE__ */Le("opacity"),borderRadius:{none:"0px",sm:"0.125rem",DEFAULT:"0.25rem",md:"0.375rem",lg:"0.5rem",xl:"0.75rem","2xl":"1rem","3xl":"1.5rem","1/2":"50%",full:"9999px"},borderSpacing:/* #__PURE__ */Le("spacing"),borderWidth:{DEFAULT:"1px",.../* #__PURE__ */xe(8,"px")},boxShadow:{sm:"0 1px 2px 0 rgba(0,0,0,0.05)",DEFAULT:"0 1px 3px 0 rgba(0,0,0,0.1), 0 1px 2px -1px rgba(0,0,0,0.1)",md:"0 4px 6px -1px rgba(0,0,0,0.1), 0 2px 4px -2px rgba(0,0,0,0.1)",lg:"0 10px 15px -3px rgba(0,0,0,0.1), 0 4px 6px -4px rgba(0,0,0,0.1)",xl:"0 20px 25px -5px rgba(0,0,0,0.1), 0 8px 10px -6px rgba(0,0,0,0.1)","2xl":"0 25px 50px -12px rgba(0,0,0,0.25)",inner:"inset 0 2px 4px 0 rgba(0,0,0,0.05)",none:"0 0 #0000"},boxShadowColor:Le("colors"),caretColor:/* #__PURE__ */Le("colors"),accentColor:({theme:e})=>({auto:"auto",...e("colors")}),contrast:{.../* #__PURE__ */ve(200,"",100,0,50),75:"0.75",125:"1.25"},content:{none:"none"},divideColor:/* #__PURE__ */Le("borderColor"),divideOpacity:/* #__PURE__ */Le("borderOpacity"),divideWidth:/* #__PURE__ */Le("borderWidth"),dropShadow:{sm:"0 1px 1px rgba(0,0,0,0.05)",DEFAULT:["0 1px 2px rgba(0,0,0,0.1)","0 1px 1px rgba(0,0,0,0.06)"],md:["0 4px 3px rgba(0,0,0,0.07)","0 2px 2px rgba(0,0,0,0.06)"],lg:["0 10px 8px rgba(0,0,0,0.04)","0 4px 3px rgba(0,0,0,0.1)"],xl:["0 20px 13px rgba(0,0,0,0.03)","0 8px 5px rgba(0,0,0,0.08)"],"2xl":"0 25px 25px rgba(0,0,0,0.15)",none:"0 0 #0000"},fill:({theme:e})=>({...e("colors"),none:"none"}),grayscale:{DEFAULT:"100%",0:"0"},hueRotate:{0:"0deg",15:"15deg",30:"30deg",60:"60deg",90:"90deg",180:"180deg"},invert:{DEFAULT:"100%",0:"0"},flex:{1:"1 1 0%",auto:"1 1 auto",initial:"0 1 auto",none:"none"},flexBasis:({theme:e})=>({...e("spacing"),...we(2,6),...we(12,12),auto:"auto",full:"100%"}),flexGrow:{DEFAULT:1,0:0},flexShrink:{DEFAULT:1,0:0},fontFamily:{sans:'ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,"Noto Sans",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji"'.split(","),serif:'ui-serif,Georgia,Cambria,"Times New Roman",Times,serif'.split(","),mono:'ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,"Liberation Mono","Courier New",monospace'.split(",")},fontSize:{xs:["0.75rem","1rem"],sm:["0.875rem","1.25rem"],base:["1rem","1.5rem"],lg:["1.125rem","1.75rem"],xl:["1.25rem","1.75rem"],"2xl":["1.5rem","2rem"],"3xl":["1.875rem","2.25rem"],"4xl":["2.25rem","2.5rem"],"5xl":["3rem","1"],"6xl":["3.75rem","1"],"7xl":["4.5rem","1"],"8xl":["6rem","1"],"9xl":["8rem","1"]},fontWeight:{thin:"100",extralight:"200",light:"300",normal:"400",medium:"500",semibold:"600",bold:"700",extrabold:"800",black:"900"},gap:/* #__PURE__ */Le("spacing"),gradientColorStops:/* #__PURE__ */Le("colors"),gridAutoColumns:{auto:"auto",min:"min-content",max:"max-content",fr:"minmax(0,1fr)"},gridAutoRows:{auto:"auto",min:"min-content",max:"max-content",fr:"minmax(0,1fr)"},gridColumn:{auto:"auto","span-full":"1 / -1"},gridRow:{auto:"auto","span-full":"1 / -1"},gridTemplateColumns:{none:"none"},gridTemplateRows:{none:"none"},height:({theme:e})=>({...e("spacing"),...we(2,6),min:"min-content",max:"max-content",fit:"fit-content",auto:"auto",full:"100%",screen:"100vh"}),inset:({theme:e})=>({...e("spacing"),...we(2,4),auto:"auto",full:"100%"}),keyframes:{spin:{from:{transform:"rotate(0deg)"},to:{transform:"rotate(360deg)"}},ping:{"0%":{transform:"scale(1)",opacity:"1"},"75%,100%":{transform:"scale(2)",opacity:"0"}},pulse:{"0%,100%":{opacity:"1"},"50%":{opacity:".5"}},bounce:{"0%, 100%":{transform:"translateY(-25%)",animationTimingFunction:"cubic-bezier(0.8,0,1,1)"},"50%":{transform:"none",animationTimingFunction:"cubic-bezier(0,0,0.2,1)"}}},letterSpacing:{tighter:"-0.05em",tight:"-0.025em",normal:"0em",wide:"0.025em",wider:"0.05em",widest:"0.1em"},lineHeight:{.../* #__PURE__ */ve(10,"rem",4,3),none:"1",tight:"1.25",snug:"1.375",normal:"1.5",relaxed:"1.625",loose:"2"},margin:({theme:e})=>({auto:"auto",...e("spacing")}),maxHeight:({theme:e})=>({full:"100%",min:"min-content",max:"max-content",fit:"fit-content",screen:"100vh",...e("spacing")}),maxWidth:({theme:e,breakpoints:t})=>({...t(e("screens")),none:"none",0:"0rem",xs:"20rem",sm:"24rem",md:"28rem",lg:"32rem",xl:"36rem","2xl":"42rem","3xl":"48rem","4xl":"56rem","5xl":"64rem","6xl":"72rem","7xl":"80rem",full:"100%",min:"min-content",max:"max-content",fit:"fit-content",prose:"65ch"}),minHeight:{0:"0px",full:"100%",min:"min-content",max:"max-content",fit:"fit-content",screen:"100vh"},minWidth:{0:"0px",full:"100%",min:"min-content",max:"max-content",fit:"fit-content"},opacity:{.../* #__PURE__ */ve(100,"",100,0,10),5:"0.05",25:"0.25",75:"0.75",95:"0.95"},order:{first:"-9999",last:"9999",none:"0"},padding:/* #__PURE__ */Le("spacing"),placeholderColor:/* #__PURE__ */Le("colors"),placeholderOpacity:/* #__PURE__ */Le("opacity"),outlineColor:/* #__PURE__ */Le("colors"),outlineOffset:/* #__PURE__ */xe(8,"px"),outlineWidth:/* #__PURE__ */xe(8,"px"),ringColor:({theme:e})=>({...e("colors"),DEFAULT:"#3b82f6"}),ringOffsetColor:/* #__PURE__ */Le("colors"),ringOffsetWidth:/* #__PURE__ */xe(8,"px"),ringOpacity:({theme:e})=>({...e("opacity"),DEFAULT:"0.5"}),ringWidth:{DEFAULT:"3px",.../* #__PURE__ */xe(8,"px")},rotate:{.../* #__PURE__ */xe(2,"deg"),.../* #__PURE__ */xe(12,"deg",3),.../* #__PURE__ */xe(180,"deg",45)},saturate:/* #__PURE__ */ve(200,"",100,0,50),scale:{.../* #__PURE__ */ve(150,"",100,0,50),.../* #__PURE__ */ve(110,"",100,90,5),75:"0.75",125:"1.25"},scrollMargin:/* #__PURE__ */Le("spacing"),scrollPadding:/* #__PURE__ */Le("spacing"),sepia:{0:"0",DEFAULT:"100%"},skew:{.../* #__PURE__ */xe(2,"deg"),.../* #__PURE__ */xe(12,"deg",3)},space:/* #__PURE__ */Le("spacing"),stroke:({theme:e})=>({...e("colors"),none:"none"}),strokeWidth:/* #__PURE__ */ve(2),textColor:/* #__PURE__ */Le("colors"),textDecorationColor:/* #__PURE__ */Le("colors"),textDecorationThickness:{"from-font":"from-font",auto:"auto",.../* #__PURE__ */xe(8,"px")},textUnderlineOffset:{auto:"auto",.../* #__PURE__ */xe(8,"px")},textIndent:/* #__PURE__ */Le("spacing"),textOpacity:/* #__PURE__ */Le("opacity"),transitionDuration:({theme:e})=>({...e("durations"),DEFAULT:"150ms"}),transitionDelay:/* #__PURE__ */Le("durations"),transitionProperty:{none:"none",all:"all",DEFAULT:"color,background-color,border-color,text-decoration-color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter",colors:"color,background-color,border-color,text-decoration-color,fill,stroke",opacity:"opacity",shadow:"box-shadow",transform:"transform"},transitionTimingFunction:{DEFAULT:"cubic-bezier(0.4,0,0.2,1)",linear:"linear",in:"cubic-bezier(0.4,0,1,1)",out:"cubic-bezier(0,0,0.2,1)","in-out":"cubic-bezier(0.4,0,0.2,1)"},translate:({theme:e})=>({...e("spacing"),...we(2,4),full:"100%"}),width:({theme:e})=>({min:"min-content",max:"max-content",fit:"fit-content",screen:"100vw",...e("flexBasis")}),willChange:{scroll:"scroll-position"},zIndex:{.../* #__PURE__ */ve(50,"",1,0,10),auto:"auto"}};function we(e,t){let o={};do{for(var n=1;n<e;n++)o[`${n}/${e}`]=Number((n/e*100).toFixed(6))+"%"}while(++e<=t);return o}function xe(e,t,o=0){let n={};for(;o<=e;o=2*o||1)n[o]=o+t;return n}function ve(e,t="",o=1,n=0,r=1,i={}){for(;n<=e;n+=r)i[n]=n/o+t;return i}function Le(e){return({theme:t})=>t(e)}let $e={"*,::before,::after":{boxSizing:"border-box",borderWidth:"0",borderStyle:"solid",borderColor:"theme(borderColor.DEFAULT, currentColor)"},"::before,::after":{"--tw-content":"''"},html:{lineHeight:1.5,WebkitTextSizeAdjust:"100%",MozTabSize:"4",tabSize:4,fontFamily:`theme(fontFamily.sans, ${ye.fontFamily.sans})`,fontFeatureSettings:"theme(fontFamily.sans[1].fontFeatureSettings, normal)"},body:{margin:"0",lineHeight:"inherit"},hr:{height:"0",color:"inherit",borderTopWidth:"1px"},"abbr:where([title])":{textDecoration:"underline dotted"},"h1,h2,h3,h4,h5,h6":{fontSize:"inherit",fontWeight:"inherit"},a:{color:"inherit",textDecoration:"inherit"},"b,strong":{fontWeight:"bolder"},"code,kbd,samp,pre":{fontFamily:`theme(fontFamily.mono, ${ye.fontFamily.mono})`,fontFeatureSettings:"theme(fontFamily.mono[1].fontFeatureSettings, normal)",fontSize:"1em"},small:{fontSize:"80%"},"sub,sup":{fontSize:"75%",lineHeight:0,position:"relative",verticalAlign:"baseline"},sub:{bottom:"-0.25em"},sup:{top:"-0.5em"},table:{textIndent:"0",borderColor:"inherit",borderCollapse:"collapse"},"button,input,optgroup,select,textarea":{fontFamily:"inherit",fontSize:"100%",lineHeight:"inherit",color:"inherit",margin:"0",padding:"0"},"button,select":{textTransform:"none"},"button,[type='button'],[type='reset'],[type='submit']":{WebkitAppearance:"button",backgroundColor:"transparent",backgroundImage:"none"},":-moz-focusring":{outline:"auto"},":-moz-ui-invalid":{boxShadow:"none"},progress:{verticalAlign:"baseline"},"::-webkit-inner-spin-button,::-webkit-outer-spin-button":{height:"auto"},"[type='search']":{WebkitAppearance:"textfield",outlineOffset:"-2px"},"::-webkit-search-decoration":{WebkitAppearance:"none"},"::-webkit-file-upload-button":{WebkitAppearance:"button",font:"inherit"},summary:{display:"list-item"},"blockquote,dl,dd,h1,h2,h3,h4,h5,h6,hr,figure,p,pre":{margin:"0"},fieldset:{margin:"0",padding:"0"},legend:{padding:"0"},"ol,ul,menu":{listStyle:"none",margin:"0",padding:"0"},textarea:{resize:"vertical"},"input::placeholder,textarea::placeholder":{opacity:1,color:"theme(colors.gray.400, #9ca3af)"},'button,[role="button"]':{cursor:"pointer"},":disabled":{cursor:"default"},"img,svg,video,canvas,audio,iframe,embed,object":{display:"block",verticalAlign:"middle"},"img,video":{maxWidth:"100%",height:"auto"},"[hidden]":{display:"none"}},ke=[ee("\\[([-\\w]+):(.+)]",({1:e,2:t},o)=>({"@layer overrides":{"&":{[e]:se(`[${t}]`,"",o)}}})),ee("(group|peer)([~/][^-[]+)?",({input:e},{h:t})=>[{c:t(e)}]),ne("aspect-","aspectRatio"),ee("container",(e,{theme:t})=>{let{screens:o=t("screens"),center:n,padding:r}=t("container"),i={width:"100%",marginRight:n&&"auto",marginLeft:n&&"auto",...a("xs")};for(let e in o){let t=o[e];"string"==typeof t&&(i[$(t)]={"&":{maxWidth:t,...a(e)}})}return i;function a(e){let t=r&&("string"==typeof r?r:r[e]||r.DEFAULT);if(t)return{paddingRight:t,paddingLeft:t}}}),ne("content-","content",({_:e})=>({"--tw-content":e,content:"var(--tw-content)"})),ee("(?:box-)?decoration-(slice|clone)","boxDecorationBreak"),ee("box-(border|content)","boxSizing",({1:e})=>e+"-box"),ee("hidden",{display:"none"}),ee("table-(auto|fixed)","tableLayout"),ee(["(block|flex|table|grid|inline|contents|flow-root|list-item)","(inline-(block|flex|table|grid))","(table-(caption|cell|column|row|(column|row|footer|header)-group))"],"display"),"(float)-(left|right|none)","(clear)-(left|right|none|both)","(overflow(?:-[xy])?)-(auto|hidden|clip|visible|scroll)","(isolation)-(auto)",ee("isolate","isolation"),ee("object-(contain|cover|fill|none|scale-down)","objectFit"),ne("object-","objectPosition"),ee("object-(top|bottom|center|(left|right)(-(top|bottom))?)","objectPosition",Me),ee("overscroll(-[xy])?-(auto|contain|none)",({1:e="",2:t})=>({["overscroll-behavior"+e]:t})),ee("(static|fixed|absolute|relative|sticky)","position"),ne("-?inset(-[xy])?(?:$|-)","inset",({1:e,_:t})=>({top:"-x"!=e&&t,right:"-y"!=e&&t,bottom:"-x"!=e&&t,left:"-y"!=e&&t})),ne("-?(top|bottom|left|right)(?:$|-)","inset"),ee("(visible|collapse)","visibility"),ee("invisible",{visibility:"hidden"}),ne("-?z-","zIndex"),ee("flex-((row|col)(-reverse)?)","flexDirection",Se),ee("flex-(wrap|wrap-reverse|nowrap)","flexWrap"),ne("(flex-(?:grow|shrink))(?:$|-)"),ne("(flex)-"),ne("grow(?:$|-)","flexGrow"),ne("shrink(?:$|-)","flexShrink"),ne("basis-","flexBasis"),ne("-?(order)-"),"-?(order)-(\\d+)",ne("grid-cols-","gridTemplateColumns"),ee("grid-cols-(\\d+)","gridTemplateColumns",Te),ne("col-","gridColumn"),ee("col-(span)-(\\d+)","gridColumn",Re),ne("col-start-","gridColumnStart"),ee("col-start-(auto|\\d+)","gridColumnStart"),ne("col-end-","gridColumnEnd"),ee("col-end-(auto|\\d+)","gridColumnEnd"),ne("grid-rows-","gridTemplateRows"),ee("grid-rows-(\\d+)","gridTemplateRows",Te),ne("row-","gridRow"),ee("row-(span)-(\\d+)","gridRow",Re),ne("row-start-","gridRowStart"),ee("row-start-(auto|\\d+)","gridRowStart"),ne("row-end-","gridRowEnd"),ee("row-end-(auto|\\d+)","gridRowEnd"),ee("grid-flow-((row|col)(-dense)?)","gridAutoFlow",e=>Me(Se(e))),ee("grid-flow-(dense)","gridAutoFlow"),ne("auto-cols-","gridAutoColumns"),ne("auto-rows-","gridAutoRows"),ne("gap-x(?:$|-)","gap","columnGap"),ne("gap-y(?:$|-)","gap","rowGap"),ne("gap(?:$|-)","gap"),"(justify-(?:items|self))-",ee("justify-","justifyContent",Fe),ee("(content|items|self)-",e=>({["align-"+e[1]]:Fe(e)})),ee("(place-(content|items|self))-",({1:e,$$:t})=>({[e]:("wun".includes(t[3])?"space-":"")+t})),ne("p([xytrbl])?(?:$|-)","padding",Oe("padding")),ne("-?m([xytrbl])?(?:$|-)","margin",Oe("margin")),ne("-?space-(x|y)(?:$|-)","space",({1:e,_:t})=>({"&>:not([hidden])~:not([hidden])":{[`--tw-space-${e}-reverse`]:"0",["margin-"+{y:"top",x:"left"}[e]]:`calc(${t} * calc(1 - var(--tw-space-${e}-reverse)))`,["margin-"+{y:"bottom",x:"right"}[e]]:`calc(${t} * var(--tw-space-${e}-reverse))`}})),ee("space-(x|y)-reverse",({1:e})=>({"&>:not([hidden])~:not([hidden])":{[`--tw-space-${e}-reverse`]:"1"}})),ne("w-","width"),ne("min-w-","minWidth"),ne("max-w-","maxWidth"),ne("h-","height"),ne("min-h-","minHeight"),ne("max-h-","maxHeight"),ne("font-","fontWeight"),ne("font-","fontFamily",({_:e})=>"string"==typeof(e=k(e))[1]?{fontFamily:Ze(e)}:{fontFamily:Ze(e[0]),...e[1]}),ee("antialiased",{WebkitFontSmoothing:"antialiased",MozOsxFontSmoothing:"grayscale"}),ee("subpixel-antialiased",{WebkitFontSmoothing:"auto",MozOsxFontSmoothing:"auto"}),ee("italic","fontStyle"),ee("not-italic",{fontStyle:"normal"}),ee("(ordinal|slashed-zero|(normal|lining|oldstyle|proportional|tabular)-nums|(diagonal|stacked)-fractions)",({1:e,2:t="",3:o})=>"normal"==t?{fontVariantNumeric:"normal"}:{["--tw-"+(o?"numeric-fraction":"pt".includes(t[0])?"numeric-spacing":t?"numeric-figure":e)]:e,fontVariantNumeric:"var(--tw-ordinal) var(--tw-slashed-zero) var(--tw-numeric-figure) var(--tw-numeric-spacing) var(--tw-numeric-fraction)",...Ve({"--tw-ordinal":"var(--tw-empty,/*!*/ /*!*/)","--tw-slashed-zero":"var(--tw-empty,/*!*/ /*!*/)","--tw-numeric-figure":"var(--tw-empty,/*!*/ /*!*/)","--tw-numeric-spacing":"var(--tw-empty,/*!*/ /*!*/)","--tw-numeric-fraction":"var(--tw-empty,/*!*/ /*!*/)"})}),ne("tracking-","letterSpacing"),ne("leading-","lineHeight"),ee("list-(inside|outside)","listStylePosition"),ne("list-","listStyleType"),ee("list-","listStyleType"),ne("placeholder-opacity-","placeholderOpacity",({_:e})=>({"&::placeholder":{"--tw-placeholder-opacity":e}})),ie("placeholder-",{property:"color",selector:"&::placeholder"}),ee("text-(left|center|right|justify|start|end)","textAlign"),ee("text-(ellipsis|clip)","textOverflow"),ne("text-opacity-","textOpacity","--tw-text-opacity"),ie("text-",{property:"color"}),ne("text-","fontSize",({_:e})=>"string"==typeof e?{fontSize:e}:{fontSize:e[0],..."string"==typeof e[1]?{lineHeight:e[1]}:e[1]}),ne("indent-","textIndent"),ee("(overline|underline|line-through)","textDecorationLine"),ee("no-underline",{textDecorationLine:"none"}),ne("underline-offset-","textUnderlineOffset"),ie("decoration-",{section:"textDecorationColor",opacityVariable:!1,opacitySection:"opacity"}),ne("decoration-","textDecorationThickness"),ee("decoration-","textDecorationStyle"),ee("(uppercase|lowercase|capitalize)","textTransform"),ee("normal-case",{textTransform:"none"}),ee("truncate",{overflow:"hidden",whiteSpace:"nowrap",textOverflow:"ellipsis"}),ee("align-","verticalAlign"),ee("whitespace-","whiteSpace"),ee("break-normal",{wordBreak:"normal",overflowWrap:"normal"}),ee("break-words",{overflowWrap:"break-word"}),ee("break-all",{wordBreak:"break-all"}),ee("break-keep",{wordBreak:"keep-all"}),ie("caret-",{opacityVariable:!1,opacitySection:"opacity"}),ie("accent-",{opacityVariable:!1,opacitySection:"opacity"}),ee("bg-gradient-to-([trbl]|[tb][rl])","backgroundImage",({1:e})=>`linear-gradient(to ${_e(e," ")},var(--tw-gradient-stops))`),ie("from-",{section:"gradientColorStops",opacityVariable:!1,opacitySection:"opacity"},({_:e})=>({"--tw-gradient-from":e.value,"--tw-gradient-to":e.color({opacityValue:"0"}),"--tw-gradient-stops":"var(--tw-gradient-from),var(--tw-gradient-to)"})),ie("via-",{section:"gradientColorStops",opacityVariable:!1,opacitySection:"opacity"},({_:e})=>({"--tw-gradient-to":e.color({opacityValue:"0"}),"--tw-gradient-stops":`var(--tw-gradient-from),${e.value},var(--tw-gradient-to)`})),ie("to-",{section:"gradientColorStops",property:"--tw-gradient-to",opacityVariable:!1,opacitySection:"opacity"}),ee("bg-(fixed|local|scroll)","backgroundAttachment"),ee("bg-origin-(border|padding|content)","backgroundOrigin",({1:e})=>e+"-box"),ee(["bg-(no-repeat|repeat(-[xy])?)","bg-repeat-(round|space)"],"backgroundRepeat"),ee("bg-blend-","backgroundBlendMode"),ee("bg-clip-(border|padding|content|text)","backgroundClip",({1:e})=>e+("text"==e?"":"-box")),ne("bg-opacity-","backgroundOpacity","--tw-bg-opacity"),ie("bg-",{section:"backgroundColor"}),ne("bg-","backgroundImage"),ne("bg-","backgroundPosition"),ee("bg-(top|bottom|center|(left|right)(-(top|bottom))?)","backgroundPosition",Me),ne("bg-","backgroundSize"),ne("rounded(?:$|-)","borderRadius"),ne("rounded-([trbl]|[tb][rl])(?:$|-)","borderRadius",({1:e,_:t})=>{let o={t:["tl","tr"],r:["tr","br"],b:["bl","br"],l:["bl","tl"]}[e]||[e,e];return{[`border-${_e(o[0])}-radius`]:t,[`border-${_e(o[1])}-radius`]:t}}),ee("border-(collapse|separate)","borderCollapse"),ne("border-opacity(?:$|-)","borderOpacity","--tw-border-opacity"),ee("border-(solid|dashed|dotted|double|none)","borderStyle"),ne("border-spacing(-[xy])?(?:$|-)","borderSpacing",({1:e,_:t})=>({...Ve({"--tw-border-spacing-x":"0","--tw-border-spacing-y":"0"}),["--tw-border-spacing"+(e||"-x")]:t,["--tw-border-spacing"+(e||"-y")]:t,"border-spacing":"var(--tw-border-spacing-x) var(--tw-border-spacing-y)"})),ie("border-([xytrbl])-",{section:"borderColor"},Oe("border","Color")),ie("border-"),ne("border-([xytrbl])(?:$|-)","borderWidth",Oe("border","Width")),ne("border(?:$|-)","borderWidth"),ne("divide-opacity(?:$|-)","divideOpacity",({_:e})=>({"&>:not([hidden])~:not([hidden])":{"--tw-divide-opacity":e}})),ee("divide-(solid|dashed|dotted|double|none)",({1:e})=>({"&>:not([hidden])~:not([hidden])":{borderStyle:e}})),ee("divide-([xy]-reverse)",({1:e})=>({"&>:not([hidden])~:not([hidden])":{["--tw-divide-"+e]:"1"}})),ne("divide-([xy])(?:$|-)","divideWidth",({1:e,_:t})=>{let o={x:"lr",y:"tb"}[e];return{"&>:not([hidden])~:not([hidden])":{[`--tw-divide-${e}-reverse`]:"0",[`border-${_e(o[0])}Width`]:`calc(${t} * calc(1 - var(--tw-divide-${e}-reverse)))`,[`border-${_e(o[1])}Width`]:`calc(${t} * var(--tw-divide-${e}-reverse))`}}}),ie("divide-",{property:"borderColor",selector:"&>:not([hidden])~:not([hidden])"}),ne("ring-opacity(?:$|-)","ringOpacity","--tw-ring-opacity"),ie("ring-offset-",{property:"--tw-ring-offset-color",opacityVariable:!1}),ne("ring-offset(?:$|-)","ringOffsetWidth","--tw-ring-offset-width"),ee("ring-inset",{"--tw-ring-inset":"inset"}),ie("ring-",{property:"--tw-ring-color"}),ne("ring(?:$|-)","ringWidth",({_:e},{theme:t})=>({...Ve({"--tw-ring-offset-shadow":"0 0 #0000","--tw-ring-shadow":"0 0 #0000","--tw-shadow":"0 0 #0000","--tw-shadow-colored":"0 0 #0000","&":{"--tw-ring-inset":"var(--tw-empty,/*!*/ /*!*/)","--tw-ring-offset-width":t("ringOffsetWidth","","0px"),"--tw-ring-offset-color":B(t("ringOffsetColor","","#fff")),"--tw-ring-color":B(t("ringColor","","#93c5fd"),{opacityVariable:"--tw-ring-opacity"}),"--tw-ring-opacity":t("ringOpacity","","0.5")}}),"--tw-ring-offset-shadow":"var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color)","--tw-ring-shadow":`var(--tw-ring-inset) 0 0 0 calc(${e} + var(--tw-ring-offset-width)) var(--tw-ring-color)`,boxShadow:"var(--tw-ring-offset-shadow),var(--tw-ring-shadow),var(--tw-shadow)"})),ie("shadow-",{section:"boxShadowColor",opacityVariable:!1,opacitySection:"opacity"},({_:e})=>({"--tw-shadow-color":e.value,"--tw-shadow":"var(--tw-shadow-colored)"})),ne("shadow(?:$|-)","boxShadow",({_:e})=>({...Ve({"--tw-ring-offset-shadow":"0 0 #0000","--tw-ring-shadow":"0 0 #0000","--tw-shadow":"0 0 #0000","--tw-shadow-colored":"0 0 #0000"}),"--tw-shadow":Ze(e),"--tw-shadow-colored":Ze(e).replace(/([^,]\s+)(?:#[a-f\d]+|(?:(?:hsl|rgb)a?|hwb|lab|lch|color|var)\(.+?\)|[a-z]+)(,|$)/g,"$1var(--tw-shadow-color)$2"),boxShadow:"var(--tw-ring-offset-shadow),var(--tw-ring-shadow),var(--tw-shadow)"})),ne("(opacity)-"),ee("mix-blend-","mixBlendMode"),...ze(),...ze("backdrop-"),ne("transition(?:$|-)","transitionProperty",(e,{theme:t})=>({transitionProperty:Ze(e),transitionTimingFunction:"none"==e._?void 0:Ze(t("transitionTimingFunction","")),transitionDuration:"none"==e._?void 0:Ze(t("transitionDuration",""))})),ne("duration(?:$|-)","transitionDuration","transitionDuration",Ze),ne("ease(?:$|-)","transitionTimingFunction","transitionTimingFunction",Ze),ne("delay(?:$|-)","transitionDelay","transitionDelay",Ze),ne("animate(?:$|-)","animation",(e,{theme:t,h:o,e:n})=>{let r=Ze(e),i=r.split(" "),a=t("keyframes",i[0]);return a?{["@keyframes "+(i[0]=n(o(i[0])))]:a,animation:i.join(" ")}:{animation:r}}),"(transform)-(none)",ee("transform",je),ee("transform-(cpu|gpu)",({1:e})=>({"--tw-transform":Ee("gpu"==e)})),ne("scale(-[xy])?-","scale",({1:e,_:t})=>({["--tw-scale"+(e||"-x")]:t,["--tw-scale"+(e||"-y")]:t,...je()})),ne("-?(rotate)-","rotate",Ae),ne("-?(translate-[xy])-","translate",Ae),ne("-?(skew-[xy])-","skew",Ae),ee("origin-(center|((top|bottom)(-(left|right))?)|left|right)","transformOrigin",Me),"(appearance)-",ne("(columns)-"),"(columns)-(\\d+)","(break-(?:before|after|inside))-",ne("(cursor)-"),"(cursor)-",ee("snap-(none)","scroll-snap-type"),ee("snap-(x|y|both)",({1:e})=>({...Ve({"--tw-scroll-snap-strictness":"proximity"}),"scroll-snap-type":e+" var(--tw-scroll-snap-strictness)"})),ee("snap-(mandatory|proximity)","--tw-scroll-snap-strictness"),ee("snap-(?:(start|end|center)|align-(none))","scroll-snap-align"),ee("snap-(normal|always)","scroll-snap-stop"),ee("scroll-(auto|smooth)","scroll-behavior"),ne("scroll-p([xytrbl])?(?:$|-)","padding",Oe("scroll-padding")),ne("-?scroll-m([xytrbl])?(?:$|-)","scroll-margin",Oe("scroll-margin")),ee("touch-(auto|none|manipulation)","touch-action"),ee("touch-(pinch-zoom|pan-(?:(x|left|right)|(y|up|down)))",({1:e,2:t,3:o})=>({...Ve({"--tw-pan-x":"var(--tw-empty,/*!*/ /*!*/)","--tw-pan-y":"var(--tw-empty,/*!*/ /*!*/)","--tw-pinch-zoom":"var(--tw-empty,/*!*/ /*!*/)","--tw-touch-action":"var(--tw-pan-x) var(--tw-pan-y) var(--tw-pinch-zoom)"}),[`--tw-${t?"pan-x":o?"pan-y":e}`]:e,"touch-action":"var(--tw-touch-action)"})),ee("outline-none",{outline:"2px solid transparent","outline-offset":"2px"}),ee("outline",{outlineStyle:"solid"}),ee("outline-(dashed|dotted|double)","outlineStyle"),ne("-?(outline-offset)-"),ie("outline-",{opacityVariable:!1,opacitySection:"opacity"}),ne("outline-","outlineWidth"),"(pointer-events)-",ne("(will-change)-"),"(will-change)-",["resize(?:-(none|x|y))?","resize",({1:e})=>({x:"horizontal",y:"vertical"}[e]||e||"both")],ee("select-(none|text|all|auto)","userSelect"),ie("fill-",{section:"fill",opacityVariable:!1,opacitySection:"opacity"}),ie("stroke-",{section:"stroke",opacityVariable:!1,opacitySection:"opacity"}),ne("stroke-","strokeWidth"),ee("sr-only",{position:"absolute",width:"1px",height:"1px",padding:"0",margin:"-1px",overflow:"hidden",whiteSpace:"nowrap",clip:"rect(0,0,0,0)",borderWidth:"0"}),ee("not-sr-only",{position:"static",width:"auto",height:"auto",padding:"0",margin:"0",overflow:"visible",whiteSpace:"normal",clip:"auto"})];function Me(e){return("string"==typeof e?e:e[1]).replace(/-/g," ").trim()}function Se(e){return("string"==typeof e?e:e[1]).replace("col","column")}function _e(e,t="-"){let o=[];for(let t of e)o.push({t:"top",r:"right",b:"bottom",l:"left"}[t]);return o.join(t)}function Ze(e){return e&&""+(e._||e)}function Fe({$$:e}){return({r:"flex-","":"flex-",w:"space-",u:"space-",n:"space-"}[e[3]||""]||"")+e}function Oe(e,t=""){return({1:o,_:n})=>{let r={x:"lr",y:"tb"}[o]||o+o;return r?{...le(e+"-"+_e(r[0])+t,n),...le(e+"-"+_e(r[1])+t,n)}:le(e+t,n)}}function ze(e=""){let t=["blur","brightness","contrast","grayscale","hue-rotate","invert",e&&"opacity","saturate","sepia",!e&&"drop-shadow"].filter(Boolean),o={};for(let n of t)o[`--tw-${e}${n}`]="var(--tw-empty,/*!*/ /*!*/)";return o={...Ve(o),[`${e}filter`]:t.map(t=>`var(--tw-${e}${t})`).join(" ")},[`(${e}filter)-(none)`,ee(`${e}filter`,o),...t.map(t=>ne(`${"h"==t[0]?"-?":""}(${e}${t})(?:$|-)`,t,({1:e,_:n})=>({[`--tw-${e}`]:k(n).map(e=>`${t}(${e})`).join(" "),...o})))]}function Ae({1:e,_:t}){return{["--tw-"+e]:t,...je()}}function je(){return{...Ve({"--tw-translate-x":"0","--tw-translate-y":"0","--tw-rotate":"0","--tw-skew-x":"0","--tw-skew-y":"0","--tw-scale-x":"1","--tw-scale-y":"1","--tw-transform":Ee()}),transform:"var(--tw-transform)"}}function Ee(e){return[e?"translate3d(var(--tw-translate-x),var(--tw-translate-y),0)":"translateX(var(--tw-translate-x)) translateY(var(--tw-translate-y))","rotate(var(--tw-rotate))","skewX(var(--tw-skew-x))","skewY(var(--tw-skew-y))","scaleX(var(--tw-scale-x))","scaleY(var(--tw-scale-y))"].join(" ")}function Re({1:e,2:t}){return`${e} ${t} / ${e} ${t}`}function Te({1:e}){return`repeat(${e},minmax(0,1fr))`}function Ve(e){return{"@layer defaults":{"*,::before,::after":e,"::backdrop":e}}}let De=[["sticky","@supports ((position: -webkit-sticky) or (position:sticky))"],["motion-reduce","@media (prefers-reduced-motion:reduce)"],["motion-safe","@media (prefers-reduced-motion:no-preference)"],["print","@media print"],["(portrait|landscape)",({1:e})=>`@media (orientation:${e})`],["contrast-(more|less)",({1:e})=>`@media (prefers-contrast:${e})`],["(first-(letter|line)|placeholder|backdrop|before|after)",({1:e})=>`&::${e}`],["(marker|selection)",({1:e})=>`& *::${e},&::${e}`],["file","&::file-selector-button"],["(first|last|only)",({1:e})=>`&:${e}-child`],["even","&:nth-child(2n)"],["odd","&:nth-child(odd)"],["open","&[open]"],["(aria|data)-",({1:e,$$:t},o)=>t&&`&[${e}-${o.theme(e,t)||se(t,"",o)||`${t}="true"`}]`],["((group|peer)(~[^-[]+)?)(-\\[(.+)]|[-[].+?)(\\/.+)?",({2:e,3:t="",4:o,5:n="",6:r=t},{e:i,h:a,v:l})=>{let s=de(n)||("["==o[0]?o:l(o.slice(1)));return`${(s.includes("&")?s:"&"+s).replace(/&/g,`:merge(.${i(a(e+r))})`)}${"p"==e[0]?"~":" "}&`}],["(ltr|rtl)",({1:e})=>`[dir="${e}"] &`],["supports-",({$$:e},t)=>{if(e&&(e=t.theme("supports",e)||se(e,"",t)),e)return e.includes(":")||(e+=":var(--tw)"),/^\w*\s*\(/.test(e)||(e=`(${e})`),`@supports ${e.replace(/\b(and|or|not)\b/g," $1 ").trim()}`}],["max-",({$$:e},t)=>{if(e&&(e=t.theme("screens",e)||se(e,"",t)),"string"==typeof e)return`@media not all and (min-width:${e})`}],["min-",({$$:e},t)=>(e&&(e=se(e,"",t)),e&&`@media (min-width:${e})`)],[/^\[(.+)]$/,({1:e})=>/[&@]/.test(e)&&de(e).replace(/[}]+$/,"").split("{")]],We={__proto__:null,slate:{50:"#f8fafc",100:"#f1f5f9",200:"#e2e8f0",300:"#cbd5e1",400:"#94a3b8",500:"#64748b",600:"#475569",700:"#334155",800:"#1e293b",900:"#0f172a"},gray:{50:"#f9fafb",100:"#f3f4f6",200:"#e5e7eb",300:"#d1d5db",400:"#9ca3af",500:"#6b7280",600:"#4b5563",700:"#374151",800:"#1f2937",900:"#111827"},zinc:{50:"#fafafa",100:"#f4f4f5",200:"#e4e4e7",300:"#d4d4d8",400:"#a1a1aa",500:"#71717a",600:"#52525b",700:"#3f3f46",800:"#27272a",900:"#18181b"},neutral:{50:"#fafafa",100:"#f5f5f5",200:"#e5e5e5",300:"#d4d4d4",400:"#a3a3a3",500:"#737373",600:"#525252",700:"#404040",800:"#262626",900:"#171717"},stone:{50:"#fafaf9",100:"#f5f5f4",200:"#e7e5e4",300:"#d6d3d1",400:"#a8a29e",500:"#78716c",600:"#57534e",700:"#44403c",800:"#292524",900:"#1c1917"},red:{50:"#fef2f2",100:"#fee2e2",200:"#fecaca",300:"#fca5a5",400:"#f87171",500:"#ef4444",600:"#dc2626",700:"#b91c1c",800:"#991b1b",900:"#7f1d1d"},orange:{50:"#fff7ed",100:"#ffedd5",200:"#fed7aa",300:"#fdba74",400:"#fb923c",500:"#f97316",600:"#ea580c",700:"#c2410c",800:"#9a3412",900:"#7c2d12"},amber:{50:"#fffbeb",100:"#fef3c7",200:"#fde68a",300:"#fcd34d",400:"#fbbf24",500:"#f59e0b",600:"#d97706",700:"#b45309",800:"#92400e",900:"#78350f"},yellow:{50:"#fefce8",100:"#fef9c3",200:"#fef08a",300:"#fde047",400:"#facc15",500:"#eab308",600:"#ca8a04",700:"#a16207",800:"#854d0e",900:"#713f12"},lime:{50:"#f7fee7",100:"#ecfccb",200:"#d9f99d",300:"#bef264",400:"#a3e635",500:"#84cc16",600:"#65a30d",700:"#4d7c0f",800:"#3f6212",900:"#365314"},green:{50:"#f0fdf4",100:"#dcfce7",200:"#bbf7d0",300:"#86efac",400:"#4ade80",500:"#22c55e",600:"#16a34a",700:"#15803d",800:"#166534",900:"#14532d"},emerald:{50:"#ecfdf5",100:"#d1fae5",200:"#a7f3d0",300:"#6ee7b7",400:"#34d399",500:"#10b981",600:"#059669",700:"#047857",800:"#065f46",900:"#064e3b"},teal:{50:"#f0fdfa",100:"#ccfbf1",200:"#99f6e4",300:"#5eead4",400:"#2dd4bf",500:"#14b8a6",600:"#0d9488",700:"#0f766e",800:"#115e59",900:"#134e4a"},cyan:{50:"#ecfeff",100:"#cffafe",200:"#a5f3fc",300:"#67e8f9",400:"#22d3ee",500:"#06b6d4",600:"#0891b2",700:"#0e7490",800:"#155e75",900:"#164e63"},sky:{50:"#f0f9ff",100:"#e0f2fe",200:"#bae6fd",300:"#7dd3fc",400:"#38bdf8",500:"#0ea5e9",600:"#0284c7",700:"#0369a1",800:"#075985",900:"#0c4a6e"},blue:{50:"#eff6ff",100:"#dbeafe",200:"#bfdbfe",300:"#93c5fd",400:"#60a5fa",500:"#3b82f6",600:"#2563eb",700:"#1d4ed8",800:"#1e40af",900:"#1e3a8a"},indigo:{50:"#eef2ff",100:"#e0e7ff",200:"#c7d2fe",300:"#a5b4fc",400:"#818cf8",500:"#6366f1",600:"#4f46e5",700:"#4338ca",800:"#3730a3",900:"#312e81"},violet:{50:"#f5f3ff",100:"#ede9fe",200:"#ddd6fe",300:"#c4b5fd",400:"#a78bfa",500:"#8b5cf6",600:"#7c3aed",700:"#6d28d9",800:"#5b21b6",900:"#4c1d95"},purple:{50:"#faf5ff",100:"#f3e8ff",200:"#e9d5ff",300:"#d8b4fe",400:"#c084fc",500:"#a855f7",600:"#9333ea",700:"#7e22ce",800:"#6b21a8",900:"#581c87"},fuchsia:{50:"#fdf4ff",100:"#fae8ff",200:"#f5d0fe",300:"#f0abfc",400:"#e879f9",500:"#d946ef",600:"#c026d3",700:"#a21caf",800:"#86198f",900:"#701a75"},pink:{50:"#fdf2f8",100:"#fce7f3",200:"#fbcfe8",300:"#f9a8d4",400:"#f472b6",500:"#ec4899",600:"#db2777",700:"#be185d",800:"#9d174d",900:"#831843"},rose:{50:"#fff1f2",100:"#ffe4e6",200:"#fecdd3",300:"#fda4af",400:"#fb7185",500:"#f43f5e",600:"#e11d48",700:"#be123c",800:"#9f1239",900:"#881337"}};function He({disablePreflight:e}={}){return function({colors:e,disablePreflight:t}={}){return{preflight:t?void 0:$e,theme:{...ye,colors:{inherit:"inherit",current:"currentColor",transparent:"transparent",black:"#000",white:"#fff",...e}},variants:De,rules:ke,finalize:e=>e.n&&e.d&&e.r.some(e=>/^&::(before|after)$/.test(e))&&!/(^|;)content:/.test(e.d)?{...e,d:"content:var(--tw-content);"+e.d}:e}}({colors:We,disablePreflight:e})}let Ue="undefined"!=typeof ShadowRoot&&("undefined"==typeof ShadyCSS||ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype;function Be(e){return e.shadowRoot||e.attachShadow({mode:"open"})}const Ne=()=>function(e,t=!0){let o=function(){if(Ue)try{let e=me(new CSSStyleSheet);return e.connect=t=>{let o=Be(t);o.adoptedStyleSheets=[...o.adoptedStyleSheets,e.target]},e.disconnect=S,e}catch{}let e=document.createElement("style");e.media="not all",document.head.prepend(e);let t=[me(e)],o=new WeakMap;return{get target(){return t[0].target},snapshot(){let e=t.map(e=>e.snapshot());return()=>e.forEach(e=>e())},clear(){t.forEach(e=>e.clear())},destroy(){t.forEach(e=>e.destroy())},insert(e,o,n){t[0].insert(e,o,n);let r=this.target.cssRules[o];t.forEach((e,t)=>t&&e.target.insertRule(r.cssText,o))},resume:(e,o)=>t[0].resume(e,o),connect(e){let n=document.createElement("style");Be(e).appendChild(n);let r=me(n),{cssRules:i}=this.target;for(let e=0;e<i.length;e++)r.target.insertRule(i[e].cssText,e);t.push(r),o.set(e,r)},disconnect(e){let n=t.indexOf(o.get(e));n>=0&&t.splice(n,1)}}}(),n=function(e,t){let o=pe(e),n=function({theme:e,darkMode:t,darkColor:o=S,variants:n,rules:r,hash:i,stringify:a,ignorelist:l,finalize:s}){let c=new Map,d=new Map,p=new Map,f=new Map,u=Ce(l,(e,t)=>t.test(e));n.push(["dark",Array.isArray(t)||"class"==t?`${k(t)[1]||".dark"} &`:"string"==typeof t&&"media"!=t?t:"@media (prefers-color-scheme:dark)"]);let h="function"==typeof i?e=>i(e,L):i?L:M;h!==M&&s.push(e=>({...e,n:e.n&&h(e.n),d:e.d?.replace(/--(tw(?:-[\w-]+)?)\b/g,(e,t)=>"--"+h(t).replace("#",""))}));let g={theme:function({extend:e={},...t}){let o={},n={get colors(){return r("colors")},theme:r,negative:()=>({}),breakpoints(e){let t={};for(let o in e)"string"==typeof e[o]&&(t["screen-"+o]=e[o]);return t}};return r;function r(n,a,l,s){if(n){if(({1:n,2:s}=/^(\S+?)(?:\s*\/\s*([^/]+))?$/.exec(n)||[,n]),/[.[]/.test(n)){let e=[];n.replace(/\[([^\]]+)\]|([^.[]+)/g,(t,o,n=o)=>e.push(n)),n=e.shift(),l=a,a=e.join("-")}let c=o[n]||Object.assign(Object.assign(o[n]={},i(t,n)),i(e,n));if(null==a)return c;a||(a="DEFAULT");let d=c[a]??a.split("-").reduce((e,t)=>e?.[t],c)??l;return s?B(d,{opacityValue:I(s,r)}):d}let c={};for(let o of[...Object.keys(t),...Object.keys(e)])c[o]=r(o);return c}function i(e,t){let o=e[t];return"function"==typeof o&&(o=o(n)),o&&/color|fill|stroke/i.test(t)?function e(t,o=[]){let n={};for(let r in t){let i=t[r],a=[...o,r];n[a.join("-")]=i,"DEFAULT"==r&&(a=o,n[o.join("-")]=i),"object"==typeof i&&Object.assign(n,e(i,a))}return n}(o):o}}(e),e:v,h,s:(e,t)=>a(e,t,g),d:(e,t,n)=>o(e,t,g,n),v:e=>(c.has(e)||c.set(e,fe(e,n,d,ue,g)||"&:"+e),c.get(e)),r(e,t){let o=JSON.stringify([e,t]);return p.has(o)||p.set(o,!u(e,g)&&fe(e,r,f,he,g,t)),p.get(o)},f:e=>s.reduce((e,t)=>t(e,g),e)};return g}(o),r=new Map,i=[],a=new Set;function l(e){let o=n.f(e),r=j(o);if(r&&!a.has(r)){a.add(r);let o=V(i,e);t.insert(r,o,e),i.splice(o,0,e)}return o.n}return t.resume(e=>r.set(e,e),(e,o)=>{t.insert(e,i.length,o),i.push(o),a.add(e)}),Object.defineProperties(function(e){if(!r.size)for(let e of k(o.preflight))"function"==typeof e&&(e=e(n)),e&&("string"==typeof e?Y("",_.b,Q(e),n,_.b,[],!1,!0):N(e,{},n,_.b)).forEach(l);let t=r.get(e=""+e);if(!t){let o=new Set;for(let t of G(Q(e),n))o.add(t.c).add(l(t));t=[...o].filter(Boolean).join(" "),r.set(e,t).set(t,t)}return t},Object.getOwnPropertyDescriptors({get target(){return t.target},theme:n.theme,config:o,snapshot(){let e=t.snapshot(),o=new Set(a),n=new Map(r),l=[...i];return()=>{e(),a=o,r=n,i=l}},clear(){t.clear(),a=new Set,r=new Map,i=[]},destroy(){this.clear(),t.destroy()}}))}({...e,hash:e.hash??t},o),r=function(e){let t=new MutationObserver(o);return{observe(e){t.observe(e,{attributeFilter:["class"],subtree:!0,childList:!0}),n(e),o([{target:e,type:""}])},disconnect(){t.disconnect()}};function o(e){for(let{type:t,target:o}of e)if("a"==t[0])n(o);else for(let e of o.querySelectorAll("[class]"))n(e);t.takeRecords()}function n(t){let o,n=t.getAttribute?.("class");var r,i;n&&(r=n)!=(i=o=e(n))&&""+r.split(" ").sort()!=""+i.split(" ").sort()&&t.setAttribute("class",o)}}(n);return function(e){return class extends e{connectedCallback(){super.connectedCallback?.(),o.connect(this),r.observe(Be(this))}disconnectedCallback(){o.disconnect(this),super.disconnectedCallback?.()}constructor(...e){super(...e),this.tw=n}}}}(pe({theme:{fontFamily:{sans:["Inter","sans-serif"],mono:["Roboto Mono","monospace"]},extend:{animation:{darken:"darken 0.2s ease-out forwards",lighten:"lighten 0.2s ease-out forwards","fade-in":"fade-in 0.2s ease-out forwards","fade-out":"fade-out 0.2s ease-out forwards"},keyframes:{darken:{"0%":{opacity:0},"100%":{opacity:.5}},lighten:{"0%":{opacity:.5},"100%":{opacity:0}},"fade-in":{"0%":{opacity:0},"100%":{opacity:1}},"fade-out":{"0%":{opacity:1},"100%":{opacity:0}}}}},presets:[He({})],hash:!1}));let Ie;const Pe=o(Ie||(Ie=(e=>e)`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="w-12 h-12"><g><path d="M20.5 11H19V7c0-1.1-.9-2-2-2h-4V3.5C13 2.12 11.88 1 10.5 1S8 2.12 8 3.5V5H4c-1.1 0-1.99.9-1.99 2v3.8H3.5c1.49 0 2.7 1.21 2.7 2.7s-1.21 2.7-2.7 2.7H2V20c0 1.1.9 2 2 2h3.8v-1.5c0-1.49 1.21-2.7 2.7-2.7 1.49 0 2.7 1.21 2.7 2.7V22H17c1.1 0 2-.9 2-2v-4h1.5c1.38 0 2.5-1.12 2.5-2.5S21.88 11 20.5 11z"></path></g></svg>`));function Ge(){return Ge=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e},Ge.apply(this,arguments)}const Ye="bc-color-",qe={primary:"#2EA7FF",secondary:"#0045B1",tertiary:void 0,"bg-primary":"#FFFFFF","bg-secondary":"#000000","text-primary":"#FFFFFF","text-secondary":"#404040","text-tertiary":"#FFFFFF"};function Je(e,t=qe[e]){return`var(--${Ye}${e}, ${t})`}const Xe="transition-all hover:brightness-110 active:scale-95";let Ke,Qe=e=>e;class et extends(Ne()(y)){constructor(e,t,o,n){super(),this._connectorType=e,this._title=t,this._background=o,this._icon=n}render(){return n(Ke||(Ke=Qe`<div
    ...
    >
      ...
      <span
        ...
        >${0}</span
      >
    </div>`),Xe,this._onClick,this._background,this._icon,Je("text-secondary"),this._title)}_connect(e){C.getState().connect(Ge({},e,{connectorName:this._title,connectorType:this._connectorType}))}}let tt,ot=class extends et{constructor(){super("extension.generic","Extension","linear-gradient(180deg, #E7E7E7 63.72%, #D1D1D1 95.24%)",Pe)}_onClick(){this._connect({})}};ot=c([i("bc-extension-connector")],ot);const nt=o(tt||(tt=(e=>e)`<svg width="45" height="64" viewBox="0 0 45 64" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`));let rt,it=class extends et{constructor(){super("nwc.alby","Alby NWC","linear-gradient(180deg, #FFDE6E 63.72%, #F8C455 95.24%)",nt)}async _onClick(){const e=s.NostrWebLNProvider.withNewSecret();await e.initNWC({name:"Bitcoin Connect"}),this._connect({nwcUrl:e.getNostrWalletConnectUrl(!0)})}};it=c([i("bc-alby-nwc-connector")],it);const at=o(rt||(rt=(e=>e)`<svg
  width="25"
  height="24"
  viewBox="0 0 25 24"
  fill="none"
  ...
  <path
    ...
    fill="white"
  />
</svg>`));let lt=class extends et{constructor(){super("nwc.generic","NWC Generic","#7E22CD",at)}async _onClick(){const e=prompt("Enter your Nostr Wallet Connect URL");e&&this._connect({nwcUrl:e})}};lt=c([i("bc-nwc-connector")],lt);let st,ct,dt,pt=e=>e,ft=class extends(Ne()(y)){render(){return n(st||(st=pt` <div class="flex justify-center items-start flex-wrap">
      ${0}
      <bc-alby-nwc-connector></bc-alby-nwc-connector>
      <bc-nwc-connector></bc-nwc-connector>
    </div>`),window.webln?n(ct||(ct=pt`<bc-extension-connector></bc-extension-connector>`)):null)}};function ut(){return`background: -webkit-linear-gradient(${Je("primary")}, ${Je("secondary")});\n  -webkit-background-clip: text;\n  -webkit-text-fill-color: transparent;`}ft=c([i("bc-connector-list")],ft);const ht=o(dt||(dt=(e=>e)`<svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 hover-right-up">
...
`),Je("primary"),Je("secondary"));let gt,Ct,bt=e=>e;function mt(){return n(gt||(gt=bt`<hr
    class="border-t w-full"
    style="border-color: ${0}"
  />`),Je("text-secondary"))}const yt=o(Ct||(Ct=(e=>e)`<svg width="49" height="24" viewBox="0 0 49 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-16 h-16 -my-4">
...
`),Je("text-tertiary","black"),Je("text-tertiary","black"),Je("text-tertiary","black"));let wt,xt,vt,Lt,$t=e=>e,kt=(xt=class extends(wt=Ne()(m)){render(){return n(vt||(vt=$t`<button
    ...
    >
      ...
      ></div>
      <slot></slot>
    </button>`),Xe,Je("bg-primary"),Je("bg-primary"),Je("primary"),Je("secondary"))}},xt.styles=[...wt.styles,e(Lt||(Lt=$t`
    ...
    `))],xt);kt=c([i("bci-button")],kt);let Mt,St,_t=e=>e,Zt=class extends(Ne()(y)){render(){return n(Mt||(Mt=_t`<div>
    ...
    </div>`),ut(),Je("text-secondary"),Je("text-secondary"),ut(),ht,ut(),ht,mt(),Je("text-secondary"),yt)}};Zt=c([i("bc-help")],Zt);const Ft=o(St||(St=(e=>e)`
...
`),Je("primary"),Je("secondary"));let Ot,zt,At=e=>e;const jt=o(Ot||(Ot=At`
...
`),Je("text-primary"),Je("text-primary")),Et=o(zt||(zt=At`
<svg class="animate-spin h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
      <circle class="opacity-25" cx="12" cy="12" r="10" stroke="${0}" stroke-width="4"></circle>
      <path class="opacity-75" fill="${0}" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
    </svg>
`),Je("text-secondary"),Je("text-secondary"));let Rt,Tt,Vt,Dt,Wt,Ht=e=>e,Ut=class extends(Ne()(y)){render(){return n(Rt||(Rt=Ht`<div class="flex flex-col justify-center items-center w-full">
      ${0}
    </div>`),this._connecting?n(Tt||(Tt=Ht`<div class="py-32">${0}</div>`),Et):this._connected?n(Vt||(Vt=Ht` <h1
            ...
            </bci-button>`),Je("text-secondary"),ut(),this._alias||"Anon",Je("text-secondary"),Je("text-secondary"),ut(),this._balance||0,mt(),Je("text-secondary"),this._connectorName,this._handleDisconnect,Ft,ut()):n(Dt||(Dt=Ht`
            <h1
            ...
            <bc-connector-list />
          `),Je("text-secondary")))}_handleDisconnect(){C.getState().disconnect()}};Ut=c([i("bc-start")],Ut);const Bt=o(Wt||(Wt=(e=>e)`<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 ${0}">
...
`),Xe,Je("text-secondary"));let Nt,It=e=>e,Pt=class extends(Ne()(y)){constructor(){super(...arguments),this.to="/start"}render(){return n(Nt||(Nt=It`<div
    ...
    </div>`),()=>C.getState().setRoute(this.to),Bt,Je("text-secondary"),this.heading)}};c([a()],Pt.prototype,"heading",void 0),c([a()],Pt.prototype,"to",void 0),Pt=c([i("bc-navbar")],Pt);let Gt,Yt,qt=e=>e;const Jt={"/start":n(Gt||(Gt=qt`<bc-start class="flex w-full"></bc-start>`)),"/help":n(Yt||(Yt=qt`<bc-help class="flex w-full"></bc-help>`))};let Xt,Kt,Qt=e=>e,eo=class extends(Ne()(y)){constructor(){super(),this._route=C.getState().route,C.subscribe(e=>{this._route=e.route})}render(){return n(Xt||(Xt=Qt`<div class="flex flex-col w-full pt-8">
      ${0}
    </div>`),Jt[this._route])}};c([r()],eo.prototype,"_route",void 0),eo=c([i("bc-router-outlet")],eo);const to=o(Kt||(Kt=(e=>e)`<svg width="172" height="24" viewBox="0 0 172 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`),Je("bg-primary"),Je("bg-primary"),Je("bg-primary"),Je("bg-primary"),Je("text-secondary"),Je("text-secondary"),Je("text-secondary"),Je("text-secondary"),Je("text-secondary"),Je("text-secondary"),Je("text-secondary"),Je("text-secondary"),Je("text-secondary"),Je("text-secondary"),Je("text-secondary"),Je("text-secondary"),Je("text-secondary"),Je("text-secondary"),Je("primary"),Je("secondary"),Je("primary"),Je("secondary"),Je("primary"),Je("secondary"));let oo;const no=o(oo||(oo=(e=>e)`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 ${0}">
...
`),Xe,Je("text-secondary"),Je("text-secondary"));let ro;const io=o(ro||(ro=(e=>e)`<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none" class="w-5 h-5 ${0}">
    ...
    </svg>`),Xe,Je("text-secondary"),Je("text-secondary"),Je("text-secondary"));let ao,lo=e=>e,so=class extends(Ne()(y)){render(){return n(ao||(ao=lo`<div
    ...
    >
      ...
      ${0}
    </div>`),()=>C.getState().setRoute("/help"),io,this._handleClose,no,to)}_handleClose(){var e;null==(e=this.onClose)||e.call(this)}};c([a()],so.prototype,"onClose",void 0),so=c([i("bc-modal-header")],so);let co,po,fo=e=>e,uo=class extends(Ne()(y)){constructor(){super(),this._closing=!1,this.open=!1,this._handleClose=()=>{this._closing=!0,setTimeout(()=>{var e;this.open=!1,this._closing=!1,C.getState().setRoute("/start"),null==(e=this.onClose)||e.call(this)},200)},C.subscribe((e,t)=>{e.connected===t.connected||e.connected||this._handleClose()})}connectedCallback(){super.connectedCallback(),h("bc:modalopened")}disconnectedCallback(){super.disconnectedCallback(),h("bc:modalclosed")}render(){return this.open?n(co||(co=fo` <div
    ...
    </div>`),this._closing?"animate-lighten":"animate-darken",Je("bg-secondary"),this._closing?"animate-fade-out":"animate-fade-in",Je("bg-primary"),this._handleClose):null}};c([a({attribute:"on-close"})],uo.prototype,"onClose",void 0),c([r()],uo.prototype,"_closing",void 0),c([a()],uo.prototype,"open",void 0),uo=c([i("bc-modal")],uo);const ho=o(po||(po=(e=>e)`
...
</svg>`),Je("text-primary"));let go;const Co=o(go||(go=(e=>e)`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`));let bo;const mo=o(bo||(bo=(e=>e)`
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`),Je("text-primary"));let yo,wo=e=>e;function xo(){return n(yo||(yo=wo`<div
    class="absolute top-0 left-0 w-full h-full rounded-lg border-2 opacity-10 pointer-events-none"
    style="border-color: ${0}"
  ></div>`),Je("bg-primary"))}let vo,Lo,$o,ko,Mo,So,_o=e=>e,Zo=class extends(Ne()(y)){constructor(){super(),this._modalOpen=!1,this.disabled=!1,this._closeModal=()=>{this._modalOpen=!1}}render(){const e=this._connecting||!this._connected&&this._modalOpen,t=this.iconOnly||this.connectedIconOnly&&this._connected;return n(vo||(vo=_o`<div>
      <div
      ...
      <bc-modal
        ...
        .onClose=${0}
      ></bc-modal>
    </div>`),Xe,this._connected&&!t?"rounded-lg gap-2 justify-center items-center":"",this._connected&&!t?`background: linear-gradient(180deg, #fff6 0%, #fff0 100%), linear-gradient(180deg, ${Je("bg-secondary")}, ${Je("bg-secondary")} 100%)`:"",this._onClick,this._connected?xo():null,t?"w-8 h-8":"h-10 px-4",this.disabled?"bg-gray-300 opacity-50":"",!this.disabled&&`\n            background: linear-gradient(180deg, ${Je("tertiary",Je("primary"))} 0%, ${Je("tertiary",Je("secondary"))} 100%);\n            color: ${Je("text-primary")};\n          `,this.disabled,xo(),e?jt:this._connected?t?mo:null:ho,t?null:n(Lo||(Lo=_o`<span class="font-semibold">
                ${0}
              </span>`),e?n($o||($o=_o`Connecting...`)):this._connected?n(ko||(ko=_o`${0}`),this._alias||"Connected"):n(Mo||(Mo=_o`Connect Wallet`))),this._connected&&!t&&void 0!==this._balance?n(So||(So=_o`<span
              class="font-medium font-sans mr-2 flex justify-center items-center gap-0.5"
              style="color: ${0}"
              >${0}<span class="font-mono">${0}</span></span
            >`),Je("text-tertiary"),Co,this._balance):null,this._modalOpen,this._closeModal)}_onClick(){this._modalOpen=!0}};c([r()],Zo.prototype,"_modalOpen",void 0),c([a({attribute:"icon-only",type:Boolean})],Zo.prototype,"iconOnly",void 0),c([a({attribute:"connected-icon-only",type:Boolean})],Zo.prototype,"connectedIconOnly",void 0),c([a({type:Boolean})],Zo.prototype,"disabled",void 0),Zo=c([i("bc-button")],Zo);export{it as AlbyNWCConnector,Zo as Button,ft as ConnectorList,ot as ExtensionConnector,lt as GenericNWCConnector,uo as Modal};
